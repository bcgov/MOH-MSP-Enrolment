  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  ngOnInit() {
    ...
    this.initProcessMembers(
      ChildInfoComponent.ProcessStepNum,
  ...
  checkUpdate() {
    ...
    this.updatedChildren.forEach((child) => {
      ...
      if (child.updateStatusInCanada === true) {
        valid =
          valid &&
          this.isSet(child.updateStatusInCanadaDocType.images) &&
      ...
      if (child.updateNameDueToNameChange === true) {
        valid =
          valid &&
          this.isSet(child.updateNameDueToNameChangeDocType.images) &&
      ...
      if (child.updateGender === true) {
        ...
        if (child.updateGenderAdditionalDocs === true) {
          ...
          valid =
            valid &&
            this.isSet(child.updateGenderDocType2.images) &&
          ...
          if (child.updateGenderAdditionalDocs2 === true) {
            ...
            valid =
              valid &&
              this.isSet(child.updateGenderDocType3.images) &&
  ...
  checkAdd() {
    ...
    this.addedChildren.forEach((addedChild) => {
      ...
      valid =
        valid &&
        this.isSet(addedChild.relationship) &&
      ...
      if (addedChild.relationship === Relationship.Child19To24) {
        ...
        valid =
          valid &&
          this.isSet(addedChild.schoolName) &&
      ...
      if (addedChild.hasActiveMedicalServicePlan === false) {
        ...
        if (addedChild.livedInBCSinceBirth === false) {
          ...
          valid =
            valid &&
            this.isSet(addedChild.arrivalToBCDate) &&
        ...
        if (addedChild.declarationForOutsideOver30Days === true) {
          valid =
            valid &&
            this.isSet(addedChild.departureDateDuring12MonthsDate) &&
        ...
        if (addedChild.declarationForOutsideOver60Days === true) {
          valid =
            valid &&
            this.isSet(addedChild.departureDateDuring6MonthsDate) &&
        ...
        if (addedChild.hasBeenReleasedFromArmedForces === true) {
          valid =
            valid &&
            this.isSet(addedChild.dischargeDate) &&
  ...
  checkRemove() {
    ...
    this.removedChildren.forEach((removedChild) => {
      ...
      if (
        removedChild.cancellationReason === CancellationReasons.ArmedForces ||
        ...
        valid =
          valid &&
          this.isSet(removedChild.cancellationDate) &&
          removedChild.cancellationDate instanceof Date;
      }

      // For this option there is a mandatory date and radio button
      if (
        removedChild.cancellationReason ===
        CancellationReasons.NoLongerInFullTimeStudies
      ) {
        valid =
          valid &&
          this.isSet(removedChild.cancellationDate) &&
