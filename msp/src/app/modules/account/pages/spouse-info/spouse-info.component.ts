  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  ngOnInit() {
    ...
    this.accountChangeOptions =
      this.dataService.accountApp.accountChangeOptions;
    this.pageStateService.setPageIncomplete(this.router.url);
    this.initProcessMembers(
      SpouseInfoComponent.ProcessStepNum,
  ...
  checkAdd() {
    ...
    if (this.accountApp.hasSpouseAdded === true) {
      ...
      valid =
        valid &&
        this.isSet(this.addedSpouse.immigrationStatusChange) &&
        // Ticked gender radio
      ...
      if (this.addedSpouse.updateNameDueToMarriage === true) {
        ...
        valid =
          ...
          typeof this.addedSpouse.updateNameDueToMarriageRequestedLastName ===
            'string' &&
          this.addedSpouse.updateNameDueToMarriageRequestedLastName.length >
            0 &&
      ...
      if (this.addedSpouse.immigrationStatusChange === false) {
        ...
        valid =
          valid &&
          this.isSet(this.addedSpouse.updateStatusInCanadaDocType) &&
        ...
        if (this.addedSpouse.hasNameChange === true) {
          valid =
            valid &&
            this.isSet(this.addedSpouse.nameChangeDocs) &&
          ...
          if (this.addedSpouse.hasNameChangeAdditional === true) {
            valid =
              valid &&
              this.isSet(this.addedSpouse.nameChangeAdditionalDocs) &&
        ...
        if (this.addedSpouse.livedInBCSinceBirth === false) {
          ...
          valid =
            valid &&
            this.isSet(this.addedSpouse.arrivalToBCDate) &&
        ...
        if (this.addedSpouse.declarationForOutsideOver30Days === true) {
          valid =
            valid &&
            this.isSet(this.addedSpouse.departureDateDuring12MonthsDate) &&
        ...
        if (this.addedSpouse.declarationForOutsideOver60Days === true) {
          valid =
            valid &&
            this.isSet(this.addedSpouse.departureDateDuring6MonthsDate) &&
        ...
        if (this.addedSpouse.hasBeenReleasedFromArmedForces === true) {
          valid =
            valid &&
            this.isSet(this.addedSpouse.dischargeDate) &&
  ...
  checkRemove() {
    ...
    if (
      ...
      valid =
        valid &&
        this.isSet(this.removedSpouse.hasCurrentMailingAddress) &&
        this.isSet(this.removedSpouse.cancellationDate);
      if (
        valid &&
        this.removedSpouse.cancellationDate.getMonth() !==
    ...
    if (
      this.removedSpouse.cancellationReason ===
        CancellationReasons.ArmedForces ||
      this.removedSpouse.cancellationReason === CancellationReasons.Deceased ||
      this.removedSpouse.cancellationReason ===
        CancellationReasons.Incarcerated ||
      this.removedSpouse.cancellationReason ===
        CancellationReasons.RemoveFromAccountButStillMarriedOrCommomLaw
    ) {
      valid =
        valid &&
        this.isSet(this.removedSpouse.cancellationDate) &&
  ...
  checkUpdate() {
    ...
    if (this.updatedSpouse.updateStatusInCanada === true) {
      valid =
        valid &&
        this.isSet(this.updatedSpouse.updateStatusInCanadaDocType.images) &&
    ...
    if (this.updatedSpouse.updateNameDueToMarriage === true) {
      valid =
        valid &&
        this.isSet(this.updatedSpouse.updateNameDueToMarriageDocType.images) &&
    ...
    if (this.updatedSpouse.updateNameDueToNameChange === true) {
      valid =
        valid &&
        this.isSet(
          this.updatedSpouse.updateNameDueToNameChangeDocType.images
        ) &&
    ...
    if (this.updatedSpouse.updateGender === true) {
      valid =
        valid &&
        this.isSet(this.updatedSpouse.updateGenderDocType.images) &&
      ...
      if (this.updatedSpouse.updateGenderAdditionalDocs === true) {
        valid =
          valid &&
          this.isSet(this.updatedSpouse.updateGenderDocType2.images) &&
        ...
        if (this.updatedSpouse.updateGenderAdditionalDocs2 === true) {
          valid =
            valid &&
            this.isSet(this.updatedSpouse.updateGenderDocType3.images) &&
    ...
    if (this.updatedSpouse.updateNameDueToError === true) {
      valid =
        valid &&
        this.isSet(this.updatedSpouse.updateNameDueToErrorDocType.images) &&
    ...
    if (this.updatedSpouse.updateBirthdate === true) {
      valid =
        valid &&
        this.isSet(this.updatedSpouse.updateBirthdateDocType.images) &&
    ...
    if (this.updatedSpouse.updateGenderDesignation === true) {
      valid =
        valid &&
        this.isSet(this.updatedSpouse.updateGenderDesignationDocType.images) &&
        this.updatedSpouse.updateGenderDesignationDocType.images.length > 0;
    }

    if (
      !this.updatedSpouse.updateGenderDesignation &&
