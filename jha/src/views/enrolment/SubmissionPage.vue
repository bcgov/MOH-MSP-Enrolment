      ...
      <main class="container pt-3 pt-sm-5 mb-3">
        ...
        >
          ...
          <ErrorBox v-else>
            <p>
              <b>
                There was an issue with your Medical Services Plan submission. Your form was not
                submitted.
              </b>
            </p>
          ...
          <ErrorBox v-if="fpcApplicationResult && fpcApplicationResult.returnCode !== '0'">
            <p>
              <b>
                There was an issue with your Fair PharmaCare submission. Your form was not
                submitted.
              </b>
            </p>
          ...
          <ErrorBox v-if="sbApplicationResult && sbApplicationResult.returnCode !== '0'">
            <p>
              <b>
                There was an issue with your Supplementary Benefits submission. Your form was not
                submitted.
              </b>
            </p>
        ...
        <div v-if="hasAnySuccessfulForms">
          ...
          <div
            v-if="mspApplicationResult && mspApplicationResult.returnCode === '0'"
          ...
          >
            ...
            <ul>
              ...
              <li>
                After your application is processed, HIBC will mail you a letter confirming your MSP
                enrolment status. You may have a
                <a
              ...
              <li>
                Living outside B.C. for more than six months could cause your MSP coverage to be
                cancelled.
                <a
          ...
          <div
            v-if="fpcApplicationResult && fpcApplicationResult.returnCode === '0'"
            class="fpc-success-message"
          >
            <p class="m-0"><strong>Fair PharmaCare:</strong></p>
            <ul>
              <li v-if="!mspApplicationResult">
                You are now registered for Fair PharmaCare with temporary coverage.&nbsp;
              </li>
              <li v-if="mspApplicationResult && mspApplicationResult.returnCode === '0'">
                Your temporary Fair PharmaCare coverage will begin once you are enrolled in MSP. You
                will receive your registration number then.&nbsp;
              </li>
              <li>
                We will send you a consent form in the mail soon, which will allow us to verify your
                income with the Canada Revenue Agency. Please sign and return the form.&nbsp;
              </li>
              <li>
                If you don't return a signed consent form, your temporary Fair PharmaCare coverage
                will end and your family's coverage will not be based on income. Your family
                deductible will default to $10,000.&nbsp;
              </li>
              <li>
                After we receive your consent form and verify your income, we will send you a letter
                that tells you what your Fair PharmaCare deductible and family maximum are.
              </li>
              <li>
          ...
          >
            ...
            <ul>
              <li>
                The Notice of Assessment or Reassessment you submitted will be used to assess your
                and your family's eligibility for Supplementary Benefits.&nbsp;
              </li>
              <li>
                After your application is processed, HIBC will mail you a letter confirming your
