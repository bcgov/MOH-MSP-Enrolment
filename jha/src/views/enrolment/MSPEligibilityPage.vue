  ...
  <div>
    ...
    <PageContent :delta-height="pageContentDeltaHeight">
      <main class="container pt-3 pt-sm-5 mb-3">
        ...
        <p>
          Answer the following questions to see which programs you are eligible for and make sure
          you have what you need to apply.
        </p>
        <h1>Medical Services Plan (MSP) eligibility</h1>
        <p>
          Note: Submit <b>only one application</b> for an Account Holder and, if needed, spouse
          and/or children. Do not submit multiple applications.
        </p>
        <hr />
        <RadioComponent
          id="apply-msp"
        ...
        <div v-if="eqMSPIsApplying === 'Y'">
          <RadioComponent
            ...
            cypress-id="live-in-bc-"
            :required="true"
            :items="radioOptionsYesNo"
          />
          <div
            v-if="eqMSPLiveInBC === 'N'"
            class="text-danger ml-4"
          >
            <p>
              If you do not live in B.C., you may not be eligible for MSP or related income-based
              programs. For more information, contact Health Insurance BC at:
            </p>
            <ContactInformation />
          </div>
          <div v-if="eqMSPLiveInBC === 'Y'">
            <RadioComponent
              ...
              cypress-id="away-over-30-"
              :required="true"
              :items="radioOptionsYesNo"
            />
            <div
              v-if="eqMSPAwayOver30 === 'Y'"
              class="text-danger ml-4"
            >
              <p>
                If you leave B.C. for more than 30 days in total during the first six months after
                applying for MSP, you may not be considered a B.C. resident. You or a family member
                may not be eligible for MSP coverage or related income-based programs. For more
                information, contact Health Insurance BC at:
              </p>
              <ContactInformation />
            </div>
            <div v-if="eqMSPAwayOver30 === 'N'">
              <RadioComponent
                ...
                cypress-id="student-minor-refugee-"
                :required="true"
                :items="radioOptionsYesNo"
              />
              <div
              ...
              >
                <p>
                  You can apply for MSP with some assistance from Health Insurance BC. Contact
              ...
              <div v-if="eqMSPStudentMinorRefugee === 'N'">
                <p>
                  5. To apply for MSP, you must upload a digital copy of one the documents below for
                  each person included in this application. The document must show full legal name
                ...
                <RadioComponent
                  ...
                  cypress-id="has-documents-"
                  :required="true"
                  :items="radioOptionsYesNo"
                />
                <p
                  v-if="eqMSPHasDocuments === 'N'"
                  class="text-danger ml-4"
                >
                  You must have digital copies of the documents to apply for MSP using this form. If
                  you are not able to make digital copies, you can apply with print copies using the
                  printable form (HLTH 101) available at
                  <a
                    target="_blank"
