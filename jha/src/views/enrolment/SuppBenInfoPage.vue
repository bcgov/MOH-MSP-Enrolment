          ...
          <div class="col-md-7">
            ...
            <div v-if="hasSpouse === 'Y'">
              <p class="mt-4 mb-1 font-weight-bolder">
                Enter your spouse's {{ selectedNOAYear }} net income.
              </p>
              <CurrencyInput
            ...
            <div v-if="intNumChildren > 0">
              <p class="mt-4 mb-1 font-weight-bolder">
                How much did you claim for child care expenses in
                {{ selectedNOAYear }}?
              </p>
              <CurrencyInput
            ...
            <p class="mt-4 mb-1 font-weight-bolder">
              Did anyone on your MSP account claim a disability tax credit in
              {{ selectedNOAYear }}?
            </p>
            <RadioComponent
...
import { selectOptionsFamilyMembers } from "@/constants/select-options";
...
const validateNumChildClaims = (value, vm) => {
  return parseInt(value) <= vm.intNumChildren && parseInt(value) > 0;
};
...
const notApplyingForBoth = (value, vm) => {
  return !(
    (vm.selectedAttendantNursingRecipients.includes("child") &&
      vm.selectedDisabilityRecipients.includes("child")) ||
    (vm.selectedAttendantNursingRecipients.includes("spouse") &&
      vm.selectedDisabilityRecipients.includes("spouse")) ||
    (vm.selectedAttendantNursingRecipients.includes("ah") &&
      vm.selectedDisabilityRecipients.includes("ah"))
  );
};
...
export default {
  ...
  created() {
    ...
    this.hasAttendantNursingExpenses =
      this.$store.state.enrolmentModule.hasAttendantNursingExpenses;
  ...
  validations() {
    ...
    if (this.hasChildren === "Y") {
      ...
      validations.claimedChildCareExpenses.positiveNumberValidator =
