      ...
      <div class="container pt-3 pt-sm-5 mb-3">
        ...
        <Checkbox label="MSP Enrolment"
          ...
          <template v-slot:description>
            <p v-if="msgCodeMSP === 0" class="mt-2">Eligibility questionnaire not answered.</p>
            <p v-else-if="msgCodeMSP === 1" class="mt-2">You might not qualify for MSP or related income_based programs if you do not live in BC. Contact Health Insurance BC for more information.</p>
            <p v-else-if="msgCodeMSP === 2" class="mt-2">You or your family member might not qualify for MSP or related income-based programs if you leave the province for more than 30 days in total during the first six months after you apply - doing this could mean you are no longer considered a B.C. resident. Find out more by contacting Health Insurance BC.</p>
            <div v-else-if="msgCodeMSP === 3" class="mt-2">
            ...
            <p v-else-if="msgCodeMSP === 4" class="mt-2">Make sure you have digital copies of the above documents before completing your Joint Health Application. You will not be able to apply for MSP enrolment without these documents.</p>
            <p v-else-if="msgCodeMSP === 5" class="mt-2">In Canada, public health insurance is available to eligible residents. Canadian citizens and permanent residents can apply for provincial health insurance. The Medical Service Plan (MSP) covers the most for eligible British Columbia residents for medically-necessary insured doctor services.</p>
          </template>
        </Checkbox>
        <Checkbox label="Fair PharmaCare"
          ...
          <template v-slot:description>
            <p v-if="msgCodeFPC === 0" class="mt-2">Eligibility questionnaire not answered.</p>
            <p v-else-if="msgCodeFPC === 1" class="mt-2">You are not eligible to register for Fair PharmaCare at this time. Register after you have completed the required wait period and registered with the Medical Services Plan. If you (or your spouse) did not submit a tax return for the taxation year two years before the current year: file an income tax return with the Canada Revenue Agency for the required taxation year as soon as possible. When you have submitted your tax return(s), register your family for Fair PharmaCare. If you cannot file an income tax return for the relevant year because you are a new resident of Canada, contact Health Insurance BC.</p>
            <ul v-else-if="msgCodeFPC === 2" class="mt-2">
            ...
            <p v-else-if="msgCodeFPC === 3" class="mt-2">Fair PharmaCare helps B.C. families pay for eligible prescription drugs, dispending fees and some medical supplies. Fair PharmaCare is based on income: the less a family earns, the more help they get.</p>
          </template>
        </Checkbox>
        <Checkbox label="MSP Supplementary Benefits"
          ...
          <template v-slot:description>
            ...
            <p v-else-if="msgCodeSB === 3" class="mt-2">Medical Services Plan (MSP) supplementary benefits provide partial payment for certain medical services obtained in British Columbia and may provide access to other income-based programs.</p>
          </template>
        </Checkbox>
