    ...
    <PageContent :deltaHeight="pageContentDeltaHeight">
      <main class="container pt-3 pt-sm-5 mb-3">
        ...
        <div v-if="eqFPCIsApplying === 'Y'">
          ...
          <p id="eqFPCMeetsCriteria" class="ml-4 mb-0">
          ...
          <div class="text-danger ml-4" v-if="eqFPCMeetsCriteria === 'N'">
            ...
            <ul>
              <li>
                If you have not been a resident of B.C. for at least three
                months, apply after you have completed the required wait period.
                &nbsp;
              </li>
              <li>
                If you and/or your spouse, if applicable, did not file taxes
                with the CRA two years ago, do so as soon as possible. When you
                have submitted your tax return(s), apply for Fair PharmaCare.
                &nbsp;
              </li>
              <li>
                If you and/or your spouse, if applicable, were not able to file
                taxes with the CRA two years ago (because you did not live in
                Canada, were a minor, or were otherwise exempt from filing
                taxes), contact Health Insurance BC at:
                <ContactInformation />
              </li>
            </ul>
          </div>
          <div v-if="eqFPCMeetsCriteria === 'Y'">
            <p class="mb-0">
              3. To apply for Fair PharmaCare, you must provide the following
              information:
            </p>
            <div class="ml-4">
              <p class="mb-0 ml-4 ms-5">
            ...
            <p id="eqFPCHasInfo" class="ml-4 mb-0">
            ...
            <div class="text-danger pl-4 ml-4" v-if="eqFPCHasInfo === 'N'">
              ...
              <ul>
                ...
                <li>
                  If you and/or your spouse, if applicable, did not file taxes
                  with the CRA two years ago, do so as soon as possible. When
                  you have submitted your tax return(s), apply for Fair
                  PharmaCare. If you and/or your spouse were not able to file
                  taxes with the CRA two years ago (because you did not live in
                  Canada, were a minor, or were otherwise exempt from filing
                  taxes), contact Health Insurance BC at:
                  <ContactInformation />
        ...
        <div
          class="text-danger"
          v-if="
            v$.eqFPCIsApplying.$dirty &&
            v$.eqFPCIsApplying.validateQuestionsAnswered.$invalid
          "
          aria-live="assertive"
        >
...
const validateQuestionsAnswered = (_value, vm) => {
  if (
    ...
    (vm.eqFPCIsApplying === "Y" &&
      vm.eqFPCMeetsCriteria === "Y" &&
      !vm.eqFPCHasInfo)
  ) {
    return false;
  }
...
export default {
  ...
  created() {
    ...
    this.eqFPCMeetsCriteria =
      this.$store.state.enrolmentModule.eqFPCMeetsCriteria;
  ...
  methods: {
    ...
    saveData() {
      ...
      this.$store.dispatch(
        enrolmentModule + "/" + SET_EQ_FPC_IS_APPLYING,
        this.eqFPCIsApplying,
      );
      this.$store.dispatch(
      ...
      this.$store.dispatch(
        enrolmentModule + "/" + SET_EQ_FPC_HAS_INFO,
        this.eqFPCHasInfo,
      );
      this.$store.dispatch(
        enrolmentModule + "/" + SET_MSG_CODE_FPC,
        this.msgCode,
      );
    },
    navigateToNextPage() {
