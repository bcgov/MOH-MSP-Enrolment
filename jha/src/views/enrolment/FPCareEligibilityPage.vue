        ...
        <div v-if="eqFPCIsApplying === 'Y'">
          ...
          <div class="ml-4 mb-3">
            <p class="mb-0 ml-4 ms-5">
              a. be enrolled in MSP or be using this application form to also apply for MSP; and
            </p>
            <p class="mb-0 ml-4 ms-5">
              b. have filed an income tax return with the Canada Revenue Agency (CRA) for the
              relevant taxation year (two years before the current year).
            </p>
          </div>
          <p
            id="eqFPCMeetsCriteria"
            class="ml-4 mb-0"
          >
          ...
          <RadioComponent
            ...
            label=""
            cypress-id="meets-fpc-criteria-"
            aria-labelledby="eqFPCMeetsCriteria"
            :required="true"
            :items="radioOptionsYesNo"
          />
          <div
            v-if="eqFPCMeetsCriteria === 'N'"
            class="text-danger ml-4"
          >
            <p>You are not eligible to apply for Fair PharmaCare at this time.</p>
            <ul>
              <li>
                If you have not been a resident of B.C. for at least three months, apply after you
                have completed the required wait period. &nbsp;
              </li>
              <li>
                If you and/or your spouse, if applicable, did not file taxes with the CRA two years
                ago, do so as soon as possible. When you have submitted your tax return(s), apply
                for Fair PharmaCare. &nbsp;
              </li>
              <li>
                If you and/or your spouse, if applicable, were not able to file taxes with the CRA
                two years ago (because you did not live in Canada, were a minor, or were otherwise
          ...
          <div v-if="eqFPCMeetsCriteria === 'Y'">
            <p class="mb-0">
              3. To apply for Fair PharmaCare, you must provide the following information:
            </p>
            <div class="ml-4">
              <p class="mb-0 ml-4 ms-5">
              ...
              <p class="mb-0 ml-4 ms-5">
                b. Net Income (Line 23600) from your and (if applicable) your spouse's CRA Notice of
                Assessment (NOA), Notice of Reassessment (NORA) or federal income tax return for the
                tax year two years before the current year; and
              </p>
              <p class="ml-4 ms-5">
                c. Registered Disability Savings Plan (RDSP) income (Line 12500) if applicable.
              </p>
            </div>
            <p
              id="eqFPCHasInfo"
              class="ml-4 mb-0"
            >
              Do you have this information to include with your application?
            </p>
            <RadioComponent
              id="has-fpc-info"
            ...
            >
              <p>You must have this information to apply for Fair PharmaCare.</p>
              <ul>
                <li>
                ...
                <li>
                  If you and/or your spouse, if applicable, did not file taxes with the CRA two
                  years ago, do so as soon as possible. When you have submitted your tax return(s),
                  apply for Fair PharmaCare. If you and/or your spouse were not able to file taxes
                  with the CRA two years ago (because you did not live in Canada, were a minor, or
                  were otherwise exempt from filing taxes), contact Health Insurance BC at:
                  <ContactInformation />
                </li>
              </ul>
            </div>
  ...
  methods: {
    ...
    saveData() {
      this.$store.dispatch(
        ...
        this.eqFPCIsApplying === "Y"
      );
      this.$store.dispatch(enrolmentModule + "/" + SET_EQ_FPC_IS_APPLYING, this.eqFPCIsApplying);
      this.$store.dispatch(
        enrolmentModule + "/" + SET_EQ_FPC_MEETS_CRITERIA,
        this.eqFPCMeetsCriteria
      );
