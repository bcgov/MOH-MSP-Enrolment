      ...
      <main class="container pt-3 pt-sm-5 mb-3">
        ...
        >
          <template #description>
            <span class="field-description">
              Note: If you or your spouse (who may not live in B.C. or Canada) earned income outside
              Canada during the most recent tax year, you must submit your application for
              Supplementary Benefits using the print form (HLTH 101) available
              <a
                target="_blank"
                href="https://gov.bc.ca/ahdc"
                >here
              </a>
              .
            </span>
        ...
        <div v-if="eqSBIsApplying === 'Y'">
          ...
          <div class="ml-4">
            ...
            <p class="mb-0 ml-4 ms-5">
              b. have resided in Canada as a Canadian citizen or holder of permanent resident status
              (landed immigrant) for at least the last 12 months immediately preceding this
              application;
            </p>
            <p class="ml-4 ms-5">
              c. not be exempt from liability to pay income tax by reason of any other Act.
            </p>
          </div>
          <p
            id="eqSBMeetsCriteria"
            class="ml-4 mb-0"
          >
          ...
          >
            <template #description>
              <span class="field-description">
                <b>Note:</b> If you (the account holder) are a holder of a Canadian temporary
                permit, you are not eligible for Supplementary Benefits. Select "No" below.
              </span>
            </template>
          </RadioComponent>
          <div
            v-if="eqSBMeetsCriteria === 'N'"
            class="text-danger ml-4"
          >
            <p>
              You are not eligible to apply for Supplementary Benefits at this time. If you have not
              lived in Canada for at least the last 12 months, apply after you have met the
              residency requirements. For more information about eligibility, see
              <a
                target="_blank"
          ...
          <div v-if="eqSBMeetsCriteria === 'Y'">
            <p class="mb-0">
              3. To apply for Supplementary Benefits, you must include the following with your
              application:
            </p>
            <div class="ml-4">
              <p class="mb-0 ml-4 ms-5">
                a. Social Insurance Number (SIN) for you and (if applicable) your spouse;
              </p>
              <p class="mb-0 ml-4 ms-5">
                b. a digital copy (pdf, jpg, png) of your and if applicable, your spouse's CRA
                Notice of Assessment (NOA) or Notice of Reassessment (NORA) for the most recent tax
                year; and
              </p>
              <p class="ml-4 ms-5">
                c. Net Income (Line 23600) and Registered Disability Savings Plan (RDSP) income
                (Line 12500) if applicable, from the above CRA NOA or NORA.
              </p>
            </div>
            <p
              id="eqSBHasInfo"
              class="ml-4 mb-0"
            >
              Do you have these documents and information to include with your application?
            </p>
            <RadioComponent
              id="has-sb-info"
              v-model="eqSBhasInfo"
            ...
            <div
              v-if="eqSBhasInfo === 'N'"
              class="text-danger pl-4 ml-4"
            >
              <p>
                You must have the above documents and information to apply for Supplementary
                Benefits.
              </p>
              <ul>
                <li>
                  If you and/or your spouse, if applicable, do not have a SIN, contact Service
                  Canada before you apply. If you are a new resident to Canada and do not qualify
                  for a SIN, contact Health Insurance BC at:
                  <ContactInformation />
                </li>
                <li>
                  If you and/or your spouse, if applicable, did not file taxes with the CRA, do so
                  as soon as possible. When you have received your NOA(s), apply for Supplementary
                  Benefits. If you and/or your spouse, if applicable, were not able to file taxes
                  with the CRA (because you did not live in Canada, were a minor, or were otherwise
                  exempt from filing taxes), contact Health Insurance BC at:
                  <ContactInformation />
                </li>
              </ul>
            </div>
