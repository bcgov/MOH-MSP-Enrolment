export const SupportDocumentTypes = {
  ...
  ChangeOfNameCertificate:
    "Name change certificate / Certificate of name change",
  ...
  ChangeGenderDocs:
    "Change of gender designation, request for waiver of parental consent",
