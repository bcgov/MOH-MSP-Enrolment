...
class ApiService {
  sendApplication(formState) {
    ...
    const jsonPayload = {
      ...
      firstName: formState.ahFirstName.substring(0, firstNameMaxLength) || null,
      secondName: formState.ahMiddleName.substring(0, middleNameMaxLength) || null,
      lastName: formState.ahLastName.substring(0, lastNameMaxLength) || null,
    ...
    if (formState.hasSpouse === 'Y') {
      ...
      jsonPayload.spouse = {
        firstName: formState.spouseFirstName.substring(0, firstNameMaxLength) || null,
        secondName: formState.spouseMiddleName.substring(0, middleNameMaxLength) || null,
        lastName: formState.spouseLastName.substring(0, lastNameMaxLength) || null,
      ...
      if (formState.hasChildren === 'Y') {
        ...
        if (children.length > 0) {
          jsonPayload.medicalServicesPlan.children = children.map((child) => {
            return {
              firstName: child.firstName.substring(0, firstNameMaxLength) || null,
              secondName: child.middleName.substring(0, middleNameMaxLength) || null,
              lastName: child.lastName.substring(0, lastNameMaxLength) || null,
